...
//  PlayingCard
//
//  Created by Tatiana Paushkina on 24.08.2018.
...
class PlayingCardView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let roundedRect = UIBezierPath(roundedRect: bounds, cornerRadius: cornerRaduis)
        roundedRect.addClip()
...
extension PlayingCardView {
    ...
    private var cornerOffset: CGFloat {
        return cornerRaduis * SizeRatio.cornerOffsetToCornerRadius
    }
